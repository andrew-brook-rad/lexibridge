...
async function test() {
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session33-01-initial.png' });
    ...
    if (genesisBtn) {
      ...
      await page.screenshot({ path: 'screenshots/session33-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session33-03-pdf-view.png' });
    ...
    if (singlePageBtn) {
      ...
      await new Promise(r => setTimeout(r, 2000));
      await page.screenshot({ path: 'screenshots/session33-04-single-page.png' });
    ...
    if (bookSpreadBtn) {
      ...
      await new Promise(r => setTimeout(r, 2000));
      await page.screenshot({ path: 'screenshots/session33-05-book-spread.png' });
    ...
    if (editModeBtn) {
      ...
      await page.screenshot({ path: 'screenshots/session33-06-edit-mode.png' });
    ...
    if (pdfBtn) {
      await pdfBtn.click();
      await new Promise(r => setTimeout(r, 2000));
      await page.screenshot({ path: 'screenshots/session33-07-final-pdf.png' });
    }
    ...
    await page.screenshot({ path: 'screenshots/session33-error.png' }).catch(() => {});
    await browser.close();
    process.exit(1);
  }
}
