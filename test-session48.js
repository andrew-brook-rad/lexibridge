...
async function testApp() {
  ...
  console.log('Testing LexiBridge Lite - Session 48 Verification');
  console.log('='.repeat(50));

  try {
    // Test 1: App loads
    console.log('\n1. Loading app on port 3001...');
    await page.goto('http://localhost:3001', { waitUntil: 'networkidle0', timeout: 30000 });
    await page.screenshot({ path: 'screenshots/session48-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session48-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session48-03-single-page.png' });
    ...
    await new Promise(r => setTimeout(r, 1500));
    await page.screenshot({ path: 'screenshots/session48-04-book-spread.png' });
    ...
    await page.screenshot({ path: 'screenshots/session48-05-edit-mode.png' });
    ...
    await new Promise(r => setTimeout(r, 1500));
    await page.screenshot({ path: 'screenshots/session48-06-final-pdf.png' });
    ...
    await page.screenshot({ path: 'screenshots/session48-error.png' });
  } finally {
    await browser.close();
  }
}
