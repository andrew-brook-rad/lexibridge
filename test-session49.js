...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session49-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session49-02-genesis-loaded.png' });
    ...
    if (singlePageBtn) {
      ...
      await page.screenshot({ path: 'screenshots/session49-03-single-page.png' });
    ...
    if (bookSpreadBtn) {
      ...
      await new Promise(r => setTimeout(r, 1000));
      await page.screenshot({ path: 'screenshots/session49-04-book-spread.png' });
    ...
    if (editModeBtn) {
      ...
      await new Promise(r => setTimeout(r, 1000));
      await page.screenshot({ path: 'screenshots/session49-05-edit-mode.png' });
    ...
    if (pdfViewBtn) {
      ...
      await new Promise(r => setTimeout(r, 1000));
      await page.screenshot({ path: 'screenshots/session49-06-final-pdf.png' });
    ...
    await page.screenshot({ path: 'screenshots/session49-error.png' });
  }
