...
async function runTests() {
  ...
  console.log('Testing LexiBridge on port 3001...');
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session55-01-initial.png' });
    ...
    await wait(2000);
    await page.screenshot({ path: 'screenshots/session55-02-genesis-loaded.png' });
    ...
    await wait(1000);
    await page.screenshot({ path: 'screenshots/session55-03-single-page.png' });
    ...
    await wait(1000);
    await page.screenshot({ path: 'screenshots/session55-04-book-spread.png' });
    ...
    await wait(1000);
    await page.screenshot({ path: 'screenshots/session55-05-edit-mode.png' });
    ...
    await wait(1000);
    await page.screenshot({ path: 'screenshots/session55-06-final-pdf.png' });
    ...
    await page.screenshot({ path: 'screenshots/session55-error.png' });
  }
