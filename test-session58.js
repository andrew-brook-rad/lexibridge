...
async function runVerification() {
  console.log('Session 58 Verification Tests\n');
  ...
  try {
    ...
    // Test 1: Navigate to app (port 3001)
    console.log('1. Loading app on port 3001...');
    await page.goto('http://localhost:3001', { waitUntil: 'networkidle2', timeout: 30000 });

    // Take initial screenshot
    await page.screenshot({ path: 'screenshots/session58-01-initial.png' });
    console.log('   Screenshot: session58-01-initial.png');
    ...
    await page.screenshot({ path: 'screenshots/session58-02-genesis-loaded.png' });
    console.log('   Screenshot: session58-02-genesis-loaded.png');
    ...
    await page.screenshot({ path: 'screenshots/session58-03-single-page.png' });
    console.log('   Screenshot: session58-03-single-page.png');
    ...
    await new Promise(r => setTimeout(r, 1500));
    await page.screenshot({ path: 'screenshots/session58-04-book-spread.png' });
    console.log('   Screenshot: session58-04-book-spread.png');
    ...
    await page.screenshot({ path: 'screenshots/session58-05-edit-mode.png' });
    console.log('   Screenshot: session58-05-edit-mode.png');
    ...
    await new Promise(r => setTimeout(r, 2000));
    await page.screenshot({ path: 'screenshots/session58-06-final-pdf.png' });
    console.log('   Screenshot: session58-06-final-pdf.png');
