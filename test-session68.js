...
async function runTests() {
  console.log('=== SESSION 68 VERIFICATION ===\n');
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session68-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session68-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session68-03-pdf-view.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session68-04-single-page.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session68-05-book-spread.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session68-06-edit-mode.png' });
    ...
    await page.screenshot({ path: 'screenshots/session68-07-final.png', fullPage: true });
