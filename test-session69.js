...
async function runTests() {
  console.log('=== SESSION 69 VERIFICATION ===\n');
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session69-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session69-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session69-03-pdf-view.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session69-04-single-page.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session69-05-book-spread.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session69-06-edit-mode.png' });
    ...
    await page.screenshot({ path: 'screenshots/session69-07-final.png', fullPage: true });
