...
async function runTests() {
  console.log('=== SESSION 70 VERIFICATION ===\n');
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session70-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session70-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session70-03-pdf-view.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session70-04-single-page.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session70-05-book-spread.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session70-06-edit-mode.png' });
    ...
    await page.screenshot({ path: 'screenshots/session70-07-final.png', fullPage: true });
