...
async function runTests() {
  console.log('=== SESSION 71 VERIFICATION ===\n');
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session71-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session71-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session71-03-pdf-view.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session71-04-single-page.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session71-05-book-spread.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session71-06-edit-mode.png' });
    ...
    await page.screenshot({ path: 'screenshots/session71-07-final.png', fullPage: true });
