...
async function runTests() {
  console.log('=== SESSION 73 VERIFICATION ===\n');
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/session73-01-initial.png' });
    ...
    await page.screenshot({ path: 'screenshots/session73-02-genesis-loaded.png' });
    ...
    await page.screenshot({ path: 'screenshots/session73-03-pdf-view.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session73-04-single-page.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session73-05-book-spread.png' });
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: 'screenshots/session73-06-edit-mode.png' });
    ...
    await page.screenshot({ path: 'screenshots/session73-07-final.png', fullPage: true });
